...
if [ $1 = "crawler" ]; then
    ...
    docker exec -it solr bin/post -c 2gram /opt/solr/data/2-gram.json
    docker exec -it solr bin/post -c 3gram /opt/solr/data/3-gram.json
    docker exec -it solr bin/post -c 4gram /opt/solr/data/4-gram.json
    docker exec -it solr bin/post -c 5gram /opt/solr/data/5-gram.json
    docker exec -it solr bin/post -c 6gram /opt/solr/data/6-gram.json
    docker exec -it solr bin/post -c uc /opt/solr/data/uc.json
else
